#!/usr/bin/env python3
"""
Download request for exercise 6 (surface moisture budget).

Missing from the local /Data/gfi/share/era5/ archive: e (evaporation).
Precipitation (tp) is not requested here since it's already derivable
locally from cp + lsp, which are both on disk.
...
Run:
  python3 request_ex06_evaporation.py
...
TARGET = "/Data/gfi/share/era5/geof212_exercises/raw_cds_downloads/ex06_evaporation_monthly_1979-2017.nc"
